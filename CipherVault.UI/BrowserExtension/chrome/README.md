...
By default, Cipher™ Vault asks for confirmation before saving, and choosing Yes saves immediately.
...
4. Cipher™ Vault will show a save prompt; choose Yes to save immediately (or auto-save if Silent Mode / auto-save domains are enabled in Settings).
